...
import { ITokenBalanceConnector } from '../interface/tokenBalanceConnector.interface';
...
export class Connector implements ITokenLogoConnector, ITokenBalanceConnector {
